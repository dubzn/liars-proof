    ...
    <div className="round-result-overlay">
      <div className="round-result-modal">
        ...
        <div className="round-result-content">
          ...
          {showPlayer1Truth && (
            <div
              className={`round-result-section ${showPlayer1Truth ? "visible" : ""}`}
            >
              <div
                className={`round-result-player-card ${player1Lied ? "lied" : "truth"}`}
              >
                <div className="round-result-player-header">
                  <span className="round-result-player-name">
                    {player1Name}
                  </span>
                  <span
                    className={`round-result-status ${player1Lied ? "lied-badge" : "truth-badge"}`}
                  >
          ...
          {showPlayer2Truth && (
            <div
              className={`round-result-section ${showPlayer2Truth ? "visible" : ""}`}
            >
              <div
                className={`round-result-player-card ${player2Lied ? "lied" : "truth"}`}
              >
                <div className="round-result-player-header">
                  <span className="round-result-player-name">
                    {player2Name}
                  ...
                  <span
                    className={`round-result-status ${player2Lied ? "lied-badge" : "truth-badge"}`}
                  >
          ...
          {showResults && (
            <div
              className={`round-result-section ${showResults ? "visible" : ""}`}
            >
              <div className="round-result-changes">
                <div className="round-result-player-result">
                  <div className="round-result-player-result-header">
                    <span className="round-result-player-result-name">
                      {player1Name}
                    </span>
                  </div>
                  <div className="round-result-player-result-stats">
                    {player1ScoreChange !== 0 && (
                      <div
                        className={`round-result-stat ${player1ScoreChange > 0 ? "positive" : "negative"}`}
                      >
                    ...
                    {player1LivesChange !== 0 && (
                      <div
                        className={`round-result-stat ${player1LivesChange > 0 ? "positive" : "negative"}`}
                      >
                ...
                <div className="round-result-player-result">
                  ...
                  <div className="round-result-player-result-stats">
                    {player2ScoreChange !== 0 && (
                      <div
                        className={`round-result-stat ${player2ScoreChange > 0 ? "positive" : "negative"}`}
                      >
                        <span className="round-result-stat-label">Score:</span>
                        <span className="round-result-stat-value">
                          {player2ScoreChange > 0 ? "+" : ""}
                    ...
                    {player2LivesChange !== 0 && (
                      <div
                        className={`round-result-stat ${player2LivesChange > 0 ? "positive" : "negative"}`}
                      >
                        <span className="round-result-stat-label">Lives:</span>
                        <span className="round-result-stat-value">
                          {player2LivesChange > 0 ? "+" : ""}
        ...
        {showContinueButton && (
          <div
            className={`round-result-continue ${showContinueButton ? "visible" : ""}`}
          >
            <Button
              onClick={onContinue}
